...
# set the flask app running and config
app = Flask(__name__)
...
# dictionaries needed to run the program
metric_finders= {}
metric_readers = {}
annotation_readers = {}
panel_readers = {}
...
def hello_world():
    ...
    return 'Grafanito by tsakito'

# search route in order to be found by the panels
...
def query_metrics():
    ...
    for target in req['targets']:
        ...
        if req_type == 'table':
            results.extend(database_api_test.get_dummy_sum)
